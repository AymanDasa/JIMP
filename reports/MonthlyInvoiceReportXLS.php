...
//  ============================================
	...
	if($Status > 0){
		...
		$sheet->setCellValue('W'  . $rowNumber, number_format( floatval(  $row['MSericeAnchoragePrice']) , 2, ".", "") );  
		...
		$sheet->setCellValue('Z'  . $rowNumber, $row['MovePort3']); 
	     ...
	     $sheet->setCellValue('AL'  . $rowNumber, number_format( floatval( $row['MSericeInPrice']) , 2, ".", "") );  
	     $sheet->setCellValue('AM'  . $rowNumber, number_format( floatval( $row['MSericeOutPrice']) , 2, ".", "") );  
	     $sheet->setCellValue('AN'  . $rowNumber, number_format( floatval( $row['MovePortPrice']) , 2, ".", "") );  
	     $sheet->setCellValue('AO'  . $rowNumber, number_format( floatval( $row['MSericeBathPrice']) , 2, ".", "") );  
	     $sheet->setCellValue('AP'  . $rowNumber, number_format( floatval( $row['MGPrice']) , 2, ".", "") );  
	     $sheet->setCellValue('AQ'  . $rowNumber, number_format( floatval( $row['MSTOTAL']) , 2, ".", "") );   
	     ...
	     $sheet->setCellValue('CA'  . $rowNumber, number_format( floatval( $row['SSTOTAL']) , 2, ".", "") );  
	     $sheet->setCellValue('CA'  . $rowNumber, number_format( floatval( $row['TOTAL']), 2, ".", "") );  
	     $sheet->setCellValue('CB'  . $rowNumber, number_format( floatval( $row['is_VAT']), 2, ".", "") );  
	     $sheet->setCellValue('CC'  . $rowNumber, number_format( floatval( $row['VAT']) , 2, ".", "") );  
	     $sheet->setCellValue('CD'  . $rowNumber, number_format( floatval( $row['VAT_TOTAL']) , 2, ".", "") );  
	...
	if($Status == 0){   
		...
		$sheet->setCellValue('Z'  . $rowNumber, $row['MovePort3']); 
	     ...
	     $sheet->setCellValue('CE'  . $rowNumber, $row['Status']);
		  ...
		  $sheet->setCellValue('U'  . $rowNumber, $row['AnchorageLeaveT']);
		  $sheet->setCellValue('V'  . $rowNumber, $row['AnchorageDays']); 
		  $sheet->setCellValue('W'  .  $rowNumber, number_format( floatval($row['MSericeAnchoragePrice']) *$CNFactor, 2, ".", "") );  
		  $sheet->setCellValue('X'  . $rowNumber, $row['MovePort1']);
		  $sheet->setCellValue('Y'  . $rowNumber, $row['MovePort2']);
		  $sheet->setCellValue('Z'  . $rowNumber, $row['MovePort3']); 
	       $sheet->setCellValue('AA'  . $rowNumber, $row['TripNo']);
	       ...
	       $sheet->setCellValue('AG'  . $rowNumber, $row['MService2']);
	       $sheet->setCellValue('AK'  . $rowNumber, $row['MService3']);
	       $sheet->setCellValue('AL'  .  $rowNumber,  number_format( floatval( $row['MSericeInPrice']) *$CNFactor, 2, ".", "") );  
	       $sheet->setCellValue('AM'  .  $rowNumber,  number_format( floatval( $row['MSericeOutPrice']) *$CNFactor, 2, ".", "") );  
	       $sheet->setCellValue('AN'  .  $rowNumber,  number_format( floatval( $row['MovePortPrice']) *$CNFactor, 2, ".", "") );  
	       $sheet->setCellValue('AO'  .  $rowNumber,  number_format( floatval( $row['MSericeBathPrice']) *$CNFactor, 2, ".", "") );  
	       $sheet->setCellValue('AP'  .  $rowNumber,  number_format( floatval( $row['MGPrice']) *$CNFactor, 2, ".", "") );  
	       $sheet->setCellValue('AQ'  .  $rowNumber,  number_format( floatval( $row['MSTOTAL']) *$CNFactor, 2, ".", "") );   
	       $sheet->setCellValue('AR'  . $rowNumber, $row['SScode1']);
	       $sheet->setCellValue('AS'  . $rowNumber, $row['SSName1']);
	       $sheet->setCellValue('AT'  . $rowNumber, $row['SSUnit1']);
	       $sheet->setCellValue('AU'  . $rowNumber, $row['SSQut1']);
	       ...
	       $sheet->setCellValue('BY'  . $rowNumber, $row['SSNote4']);
	       $sheet->setCellValue('BZ'  . $rowNumber, $row['SSNote5']);
	       $sheet->setCellValue('CA'  .  $rowNumber, number_format( floatval($row['SSTOTAL']) *$CNFactor , 2, ".", "") );  
	       $sheet->setCellValue('CA'  .  $rowNumber, number_format( floatval( $row['TOTAL']) *$CNFactor, 2, ".", "") );  
	       $sheet->setCellValue('CB'  .  $rowNumber, number_format( floatval( $row['is_VAT']) *$CNFactor, 2, ".", "") );  
	       $sheet->setCellValue('CC'  .  $rowNumber, number_format( floatval( $row['VAT']) *$CNFactor, 2, ".", "") );  
	       $sheet->setCellValue('CD'  .  $rowNumber, number_format( floatval( $row['VAT_TOTAL']) *$CNFactor, 2, ".", "") );  
	       $sheet->setCellValue('CE'  . $rowNumber, $row['Status']); 
	} 
	$rowNumber++;
}
