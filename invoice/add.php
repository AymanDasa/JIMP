		...
		// option Agents 
            ...
            $AgentOption.='
			<option value="'.$Agents['Agent_ID'].'">'.$Agents['AgentNameAr'].' CR:'.$Agents['AgentCR'].'</option>';
					}
				// option Agents
								...
								<div class="col-sm-2 col-md-4 col-lg-2 col-xl-2"> 
									...
									<div class="form-group">
										<div class="custom-control custom-switch" style="padding-left: 5.25rem;">
											...
											<br>
											<input name="MService2" type="checkbox" class="custom-control-input" id="customSwitch3">
